 ...
 * Units
 *
 * @ORM\Table(name="`units`", indexes={@ORM\Index(name="created_by", columns={"created_by"}), @ORM\Index(name="modified_by", columns={"modified_by"}), @ORM\Index(name="status_id", columns={"status_id"})})
 * @ORM\Entity
 */
class Units implements EntityInterface
{
    /**
     * @var integer
     *
